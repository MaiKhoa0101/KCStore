      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse innerpage_navbar" id="navbarSupportedContent">
          <ul class="navbar-nav  ">
            ...
            <a class="nav-link" href="vonglac.php">Vòng & Lắc <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
...
<?php
  ...
  $sqlloai = "select loai from sanpham where masp like 'W%' group by loai";
